...
#
# Full footprint: Standard-tier AKS with 3 availability zones, Premium-hosting
# services enabled, Standard/Premium SKUs, HA nodes. Private-at-rest and
# secured for real traffic.
# ---------------------------------------------------------------------------
